...
class _MyBabyScreenBottombarState extends ConsumerState<MyBabyScreenBottombar> {
  ...
  var infoList = [
    ...
    "Hoş geldin 8. Ay! Bebeğinizin gerçek saçları bu dönemde oluşmaya başlar. Kemikler henüz tam sertleşmediği için doğum rahatça gerçekleşebilir ve erken doğumlarda da büyük bir sıkıntı yaşanmaz. Bebeğinizin gelişimi neredeyse tamamlanmış durumda olup, sadece sinir sistemi ve akciğerlerin tam gelişimi kalır. 5 aylık gelişimde ortaya çıkan ""lanugo"" adı verilen tüyler bu dönemde yok olmaya başlar. Bebeğiniz hala tekme atıp kilo almaya devam ederken, amniyotik sıvıdan da kurtulur. Baş aşağı pozisyonda olan bebeğinizde genellikle ilk bağırsak hareketleri gerçekleşir. Yaklaşan doğum için hazır mısınız?⭐Gebelerin vücudunda ortalama 6.6 litre su bulunur!",
    ...
    "Bebeğiniz üç aylık oldu bile! Bebeğinizin yüzünün ifadesini taklit etmeyi deneyin. Bu, onun sosyal becerilerini geliştirmesine yardımcı olur. Ona basit şarkılar söyleyebilir ve ritimli müzikler çalabilirsiniz. Dans ederken neşeli anlar yaşayacaksınız! Bebeğinizi karnını üstte kalacak şekilde yüzükoyun yatırarak zaman geçiriniz. Bu, kaslarının güçlenmesine yardımcı olacaktır. Parmak boyasıyla sanat etkinlikleri yapabilirsiniz, hem eğlenceli hem de onun duyusal gelişimine katkı sağlayacaktır.Bebeğinizin yüzündeki ifadeleri taklit ederek onunla komik bir ""yüz dili"" oluşturabilirsiniz. Şimdi bebeğiniz insanları birbirinden ayırma yetisine sahiptir. Başını ve bedenini daha iyi kontrol edebilir, nesneleri tüm ayrıntılarıyla görebilir. Son olarak uyku ve beslenme düzeni gelişir.",
    ...
    "Bebeğinizin hayal gücünü destekleyen oyuncaklarla oynamasına olanak sağlamalısınız, örneğin bebekleri beslemek veya telefon konuşması yapmak gibi rol yapma oyunlarına katılabilirsiniz. Bebeğinizin dil becerilerini desteklemek için ona farklı nesnelerin ve hayvanların isimlerini söyleyebilirsiniz. Bu kelime dağarcığını genişletmesine yardımcı olacak. Basit komutları anlamaya başlayan bebeğinizle birlikte oyunlar oynamalısınız. Örneğin, ""topu getir"" veya ""kucaklaşalım"" gibi basit talimatlar vererek onun anlama ve uygulama becerilerini desteklemelisiniz. Bebeğinizin sosyal etkileşimlerini artırmak için oyun gruplarına katılabilir veya diğer çocuklarla etkileşimde bulunabileceği ortamlar yaratabilirsiniz. Günlük rutinlerde bebeğinizin yardım etmesine ve sorumluluk almasına izin verebilir, örneğin masayı kurmak veya oyuncakları toplamak gibi görevleri onunla birlikte yapabilirsiniz. Birlikte dağıtma ve birlikte toplama zamanı!",
        ...
        actions: [
          Center(
            child: TextButton(
              ...
              child: Icon(Icons.check_circle_outline_sharp, color: Colors.green, size: 40,),
            ),
          ),
        ],
      );
