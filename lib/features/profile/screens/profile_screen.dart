  ...
  void _toggleSwitch(){
    if(_isSaved){
      ...
      ScaffoldMessenger.of(context)
          ...
          ..showSnackBar(const SnackBar(content: Text("Değişiklikleri kaydetmeden çıkamazsınız.")));
    }
  }
                      ...
                      child: Column(children: [
                        ...
                        InkWell(
                          onLongPress: () {
                            ScaffoldMessenger.of(context)
                              ..removeCurrentSnackBar()
                              ..showSnackBar(const SnackBar(content: Text("Profil resminizi değiştirmek için Bilgilerimi Düzenle'yi aktifleştirin ve bu alana tıklayın ...")));
                          },
                          onTap: () {
                            ...
                            if(_isEditing){
                              ScaffoldMessenger.of(context)
                                ..removeCurrentSnackBar()
                                ..showSnackBar(const SnackBar(content: Text("Görsel seçme fonksiyonu çalışmalı")));
                            }else{
                              ScaffoldMessenger.of(context)
                                ..removeCurrentSnackBar()
                                ..showSnackBar(const SnackBar(content: Text("Öncelikile bilgilerimi düzenleyi aktifleştirin!")));
                            }
                          },
                          child: Center(
                            child: Stack(
                        ...
                        FormBuilderTextField(
                          onTap: () {
                            ScaffoldMessenger.of(context)
                              ..removeCurrentSnackBar()
                              ..showSnackBar(const SnackBar(content: Text("E-mail adresinizi değiştirmezsiniz!")));
                          },
                          readOnly: true,
                          name: "email",
                        ...
                        FormBuilderDateTimePicker(
                          ...
                          validator: (value) {
                            ...
                            }else if(((DateTime.now().year - value!.year) < 18)){
                        ...
                        FormBuilderSwitch(
                          enabled: _isEditing,
                          name: "role",
                          subtitle: Text( isPregnant ? "Henüz doğum yapmadım." : "Doğum yaptım."),
                          title: Text( isPregnant ?
                          "Gebeyim" : "Anneyim" ,
                        ...
                        FormBuilderDropdown(
                          ...
                          decoration: const InputDecoration(
                            contentPadding: EdgeInsets.symmetric(
                                vertical: 15, horizontal: 15),
                            fillColor: CustomStyles.fillColor,
                            label: Text("Bebeğinizin Cinsiyeti"),
                          ),
                        ),
                        const SizedBox(height: 20),
                        //TODO: Bebeğin Kilosu
